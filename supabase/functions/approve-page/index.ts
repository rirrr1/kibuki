...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const updatedApprovals = { ...currentApprovals, [pageKey]: true };
    ...
    const allApproved = approvedCount === 12; // cover + 10 story pages + back cover
    ...
    console.error("Error in approve-page:", error);
    return new Response(
